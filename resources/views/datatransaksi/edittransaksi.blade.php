                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        <form id="edittransaksi" method="post">
                            ...
                            <div class="form-group">
                                <label>Saldo</label>
                                <input type="text" name="saldo" class="form-control form-control-sm" readonly value="{{ $transaksi->saldo }}">
                            </div>

                            <div class="form-group">
                                <label>Sisa Bayar</label>
                                <input type="text" name="sisa_bayar" class="form-control form-control-sm" value="{{ $transaksi->sisa_bayar }}">
                            </div>

                            <div class="form-group">
                                <label>Pembayaran</label>
                                <input type="text" name="pembayaran" class="form-control form-control-sm" value="{{ $transaksi->pembayaran }}">
                            </div>

                            Status

                            <input type=radio name="status" value="1" {{ $transaksi->status == '1' ? 'checked' : ''}}>Aktif</option>
